...
const ALL_CRYPTOS = ['BTC', 'ETH', 'LTC', 'DASH', 'ZEC', 'BCH', 'DUC']
  ...
  return machineLoader.getMachineNames()
    .then(machineList => ({
      ...
      accounts: [
        ...
        {code: 'ducatus', display: 'Ducatus', class: 'ticker', cryptos: ['DUC']},
        ...
        {code: 'ducatus', display: 'No exchange', class: 'exchange', cryptos: ['DUC']},
        ...
        {code: 'ducatuscoind', display: 'ducatuscoind', class: 'wallet', cryptos: ['DUC']}
      ],
